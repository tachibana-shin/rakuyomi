...
Settings.setting_value_definitions = {
  ...
  },
  {
    ...
    {
      type = 'string',
      title = _("AniList access token"),
      placeholder = _("Paste AniList token"),
    }
  },
  {
    ...
    {
      type = 'string',
      title = _("AniList refresh token"),
      placeholder = _("Paste AniList refresh token"),
    }
  },
  {
    'validate_anilist',
    {
      type = 'button',
      title = _("Validate AniList"),
      callback = function()
        Trapper:wrap(function()
          local response = LoadingDialog:showAndRun(
            _("Validating..."),
            function()
              return Backend.validateTrackingSettings("anilist")
            end
          )
          ...
          UIManager:show(InfoMessage:new { text = _("AniList credentials are valid.") })
        end)
      end
    }
  },
  {
    'mal_client_id',
    {
      ...
      placeholder = _("Paste MAL client ID"),
    }
  },
  {
    'mal_client_secret',
    {
      type = 'string',
      title = _("MyAnimeList client secret"),
      placeholder = _("Paste MAL client secret"),
    }
  },
  {
    'mal_refresh_token',
    {
      type = 'string',
      title = _("MyAnimeList refresh token"),
      placeholder = _("Paste MAL refresh token"),
    }
  },
  {
    'validate_mal',
    {
      type = 'button',
      title = _("Validate MyAnimeList"),
      callback = function()
        Trapper:wrap(function()
          local response = LoadingDialog:showAndRun(
            _("Validating..."),
            function()
              return Backend.validateTrackingSettings("myanimelist")
            end
          )
          ...
          UIManager:show(InfoMessage:new { text = _("MyAnimeList credentials are valid.") })
        end)
      end
    }
  },
  {
    ...
    {
      type = 'string',
      title = _("Shikimori client ID"),
      placeholder = _("Paste Shikimori client ID"),
    }
  },
  {
    ...
    {
      type = 'string',
      title = _("Shikimori client secret"),
      placeholder = _("Paste Shikimori client secret"),
    }
  },
  {
    ...
    {
      type = 'string',
      title = _("Shikimori refresh token"),
      placeholder = _("Paste Shikimori refresh token"),
    }
  },
  {
    'validate_shikimori',
    {
      type = 'button',
      title = _("Validate Shikimori"),
      callback = function()
        Trapper:wrap(function()
          local response = LoadingDialog:showAndRun(
            _("Validating..."),
            function()
              return Backend.validateTrackingSettings("shikimori")
            end
          )
          ...
          UIManager:show(InfoMessage:new { text = _("Shikimori credentials are valid.") })
        end)
      end
    }
  },
  {
    'kavita_url',
    {
      type = 'string',
      title = _("Kavita URL"),
      placeholder = 'https://kavita.example.com',
    }
  },
  {
    'kavita_api_key',
    {
      type = 'string',
      title = _("Kavita API Key"),
      placeholder = _("Paste Kavita API Key"),
    }
  },
  {
    'validate_kavita',
    {
      type = 'button',
      title = _("Validate Kavita"),
      callback = function()
        Trapper:wrap(function()
          local response = LoadingDialog:showAndRun(
            _("Validating..."),
            function()
              return Backend.validateTrackingSettings("kavita")
            end
          )
          ...
          UIManager:show(InfoMessage:new { text = _("Kavita credentials are valid.") })
        end)
      end
    }
  },
