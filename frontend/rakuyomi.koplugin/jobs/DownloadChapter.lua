...
--- @field private chapter_title string
...
function DownloadChapter:new(source_id, manga_id, chapter_id, chapter_title, chapter_num)
  local o = {
    source_id = source_id,
    manga_id = manga_id,
...
function DownloadChapter:start()
  local response = Backend.createDownloadChapterJob(self.source_id, self.manga_id, self.chapter_id, self.chapter_title, self.chapter_num)
