...
# - libuds_http_request.dylib and cbz_metadata_reader are pre-built and copied into the
...
# KOReader looks for these at plugin_dir/libuds_http_request.dylib and plugin_dir/cbz_metadata_reader.
...
cp "$REPO_ROOT/backend/target/debug/libuds_http_request.dylib" "$PLUGIN_DIR/uds_http_request"
...
export RAKUYOMI_UDS_HTTP_REQUEST_COMMAND_OVERRIDE="$REPO_ROOT/backend/target/debug/libuds_http_request.dylib"
