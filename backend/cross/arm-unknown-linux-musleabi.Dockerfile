ARG CROSS_BASE_IMAGE=ghcr.io/cross-rs/arm-unknown-linux-musleabi:0.2.5
...
ENV BINDGEN_EXTRA_CLANG_ARGS="-isystem /usr/local/arm-unknown-linux-musleabi/include"
